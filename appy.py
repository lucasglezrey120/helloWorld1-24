...
app = Flask(__name__)
# university.db is the db filename
...
def student_view_all():
    # start w student, query it, perform an left outerjoin from student to major
    # shows all students who may or may not have major
    # order them by last, first
    # show all
...
def student_view(student_id):
    ...
    if student:
        ...
        # flash function returns messages on the website
