...
with app.app_context():
    ...
    # Initial loading of users fake data
    users = [
        {'username': 'lgonza15', 'email': 'lgonza15@umd.edu', 'first_name': 'Lucas', 'last_name': 'Gonzalez-Rey',
         'password': generate_password_hash('lgonza15', method='pbkdf2:sha256'), 'role':'STUDENT'},
