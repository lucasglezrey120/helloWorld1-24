...
with app.app_context():
    ...
    students = [
        {'student_id': '1', 'first_name': 'Lucas', 'last_name': 'Gonzalez_Rey',
         'email': 'lucasglezrey120@gmail.com', 'major_id': 3,
         'birth_date': dt.datetime(2007, 6, 1), 'is_honors': 1},
        {'student_id': '2', 'first_name': 'Leo', 'last_name': 'Van Munching',
         'email': 'rhsith@umd.edu', 'major_id': 6,
    ...
    for each_student in students:
        ...
        # by using the name of the class, run the init function
