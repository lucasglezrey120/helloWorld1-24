...
class Student(db.Model):
    ...
    #looks like SQL Data definition
    student_id = db.Column(db.Integer, primary_key=True)
    first_name = db.Column(db.String(30), nullable=False)
    last_name = db.Column(db.String(50), nullable=False)
    # new email field in data definition
    ...
    #create (initialize) w default values as func params
    ...
    #print out (represent) a student instance
    def __repr__(self):
...
class Major(db.Model):
    ...
    #backtrack: students has foreign key in this table
